        ...
        <div class="w-full max-w-lg bg-slate-200 border border-slate-800 rounded-2xl shadow-xl p-8">
            ...
            <form action="{{ route('compra.store') }}" method="POST">
                ...
                <div class="mb-5">
                 ...
                 <select name="id_proveedor" id="id_proveedor" class="w-full px-3.5 py-2.5 bg-slate-300 border border-slate-300 rounded-lg text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                ...
                <div class="mb-5">
                 ...
                 <div class="mb-5">
                    ...
                    <input type="number" step="0.1" name="total" class="w-full px-3.5 py-2.5 bg-slate-300 border border-slate-300 rounded-lg text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                </div>
