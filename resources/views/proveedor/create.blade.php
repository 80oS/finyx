        ...
        <div class="w-full max-w-lg bg-slate-200 border border-slate-800 rounded-2xl shadow-xl p-8">
            ...
            <form action="{{ route('proveedores.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2">
                    <div class="mr-5">
                        <div class="mb-5">
                            <label for="" class="block text-sm font-medium text-slate-800 mb-1.5">Nit</label>
                            <input type="text" name="nit" class="w-full px-3.5 py-2.5 bg-slate-300 border border-slate-300 rounded-lg text-sm text-slate-800  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all">
                        </div>
                        <div class="mb-5">
                    ...
                    <div class="">
                        ...
                        <div class="mb-5">
                            <label for="" class="block text-sm font-medium text-slate-800 mb-1.5">Dirección</label>
                        ...
                        <div class="flex items-center justify-end gap-3 pt-4 border-t border-slate-500">
                            ...
                            >Guardar</button>
                            <a href="{{ route('proveedores.index') }}" class="bg-slate-700 hover:bg-slate-800 text-white rounded-sm px-5 py-2.5 text-right transition-all"
                            >Cancelar</a>
                        </div>
                    </div>
                </div>
